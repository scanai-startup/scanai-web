...
function WineTraceability() {
  const [selectedStage, setSelectedStage] = React.useState<ProcessStage | null>(
    null
  );
  ...
  function getStatusIcon(status: ProcessStage["status"]) {
    switch (status) {
      case "completed":
        return <IconCircleCheckFilled className="w-3 h-3 text-green-600" />;
      case "in-progress":
                ...
                <Drawer direction="right">
                  ...
                  <DrawerContent className="max-h-[100vh] w-[600px] max-w-[90vw]">
                    <DrawerHeader>
                      ...
                      <DrawerDescription>
                        Detalhes da etapa de {stage.name.toLowerCase()}
                      </DrawerDescription>
                    </DrawerHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <div className="font-medium">{stage.endDate}</div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    Monitoramento de extremos que podem prejudicar as uvas, como
                    geadas ou ondas de calor.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                      Precipitação:
                    </span>{" "}
                    Quantidade e distribuição da chuva ao longo do ciclo da
                    videira.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                    ...
                    Altos níveis podem favorecer doenças fúngicas.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                      Exposição solar:
                    </span>{" "}
                    Impacta diretamente a maturação e o desenvolvimento de
                    compostos fenólicos.
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    Textura (arenoso, argiloso, etc.), drenagem e capacidade de
                    retenção de água.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                    ...
                    Presença de nitrogênio, fósforo, potássio e outros minerais
                    essenciais.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                    ...
                    Influencia a absorção de nutrientes e o crescimento das
                    videiras.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                    ...
                    Impacta na fertilidade e na microbiota do solo.
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    Algumas são mais sensíveis a condições específicas do
                    ambiente.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                    ...
                    Videiras mais antigas podem produzir uvas de maior
                    qualidade, embora em menor quantidade.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                      Controle de poda:
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    Monitoramento e controle de fungos, insetos e outras
                    ameaças.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                    ...
                    Registro de produtos aplicados e intervalos de segurança.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                      Estresse hídrico:
                    </span>{" "}
                    Monitorar para evitar déficit ou excesso de irrigação.
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    Essencial para determinar o momento ideal da colheita.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                      Acidez (pH e acidez titulável):
                    </span>{" "}
                    Impacta no equilíbrio do sabor e na capacidade de
                  ...
                  <div>
                    ...
                    Contribuem para o corpo, cor e estrutura do vinho.
                  </div>
                  <div>
                    <span className="font-medium text-blue-600">
                      Aromas precursores:
                    </span>{" "}
                    Determinam as características sensoriais do produto final.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <Card className="p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">28/06/2024</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-purple-600">Nº Carrada:</span>
                      <span className="font-medium">3ª</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-purple-600">Lote:</span>
                      <span className="font-medium">101 - AIREN</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span className="text-purple-600">Peso Total:</span>
                      <span className="font-medium">8.040 KG</span>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-purple-600">Peso Total:</span>
                      <span className="font-medium">8.360 KG</span>
                    </div>
                  </div>
                </Card>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-purple-600">Brix:</span>
                    ...
                    <div className="flex justify-between">
                      <span className="text-purple-600">Acidez Total:</span>
                      <span className="font-medium">6.2 g/L</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-purple-600">Temperatura:</span>
                ...
                {stage.responsible && (
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium">{stage.responsible}</div>
                    </div>
                  </div>
                )}
              </div>
        ...
        <div className="flex items-center justify-between">
          ...
          {stage.responsible && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="font-medium">{stage.responsible}</span>
            </div>
          )}
        </div>
    ...
    <div className="container mx-auto p-6 max-w-6xl">
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-muted-foreground">Vinhedo</div>
                  <div className="font-medium">{data.vineyard.name}</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="font-medium">{data.currentStage}</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="font-medium">{data.estimatedCompletion}</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
      ...
      <Tabs defaultValue="process" className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="process">Processo de Produção</TabsTrigger>
          <TabsTrigger value="details">Detalhes por Etapa</TabsTrigger>
          <TabsTrigger value="vineyard">Informações do Vinhedo</TabsTrigger>
        </TabsList>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{data.vineyard.name}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{data.vineyard.area}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                        Tipo de Solo:
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">Distribuição adequada</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Umidade:</span>
                      <span className="font-medium">Níveis controlados</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                        Exposição Solar:
                      </span>
                      <span className="font-medium">Orientação ideal</span>
                    </div>
                  </div>
                </div>
              </div>
